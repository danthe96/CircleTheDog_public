...
//	 }
//	
//	 private MenuScene createHowToMenuScene(ITextureRegion picture, String
//	 text,
//	 boolean last) {
...
//	 switch (property) {
//	 /*
//	 * case 0: tiles[i][j] = new Tile( startingPointX + alternate +
//	 * (tileWidth + Math.abs(alternate) / 4) * j, startingPointY +
//	 * (tileWidth + Math.abs(alternate) / 4) * i, tileWidth,
//	 * tileWidth, circleTextureReg, getVertexBufferObjectManager(),
//	 * false, this); gameScene.registerTouchArea(tiles[i][j]);
//	 * break; case 1: tiles[i][j] = new Tile( startingPointX +
//	 * alternate + (tileWidth + Math.abs(alternate) / 4) * j,
//	 * startingPointY + (tileWidth + Math.abs(alternate) / 4) * i,
//	 * tileWidth, tileWidth, circleTextureReg,
//	 * getVertexBufferObjectManager(), true, this); break; default:
//	 */
//	
//	 }
//	 gameScene.attachChild(tiles[i][j]);
